class SpeechBubble {
	constructor(game, msg, size = 1) {
		this.config = { font: 'Calibri', size: 30, padding: 10, colour: '#f5f5dc', width: 256, height: 256 };
		...
		loader.load(
			// resource URL
			`${game.assetsPath}images/400X200+png파일.png`,
	...
	update(msg) {
		...
		context.drawImage(bg, 0, 0, this.config.width, this.config.height);
